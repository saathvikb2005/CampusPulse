  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.email && formData.password.length >= 6) {
        ...
        // Set user role based on email patterns
        if (
          formData.email === "admin@campuspulse.com" ||
          formData.email === "demo@campuspulse.com" ||
          formData.email.includes("admin")
        ) {
          localStorage.setItem("userRole", "admin");
        } else if (
          formData.email.includes("faculty") ||
          formData.email.includes("prof") ||
          formData.email.includes("teacher") ||
          formData.email.includes("dr.")
        ) {
          localStorage.setItem("userRole", "faculty");
        } else if (
          formData.email.includes("staff")
        ) {
