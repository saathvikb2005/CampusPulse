...
const UpcomingEvents = () => {
  ...
  const upcomingEvents = [
    ...
    },
    {
      ...
      prerequisites: ["Team registration (11 players)"],
                      ...
                      <div className="event-actions">
                        {regOpen ? (
                          <>
                            ...
                            >
                              <i className={`fas ${isRegistered(event.id) ? 'fa-check' : 'fa-user-plus'}`}></i>
                              {isRegistered(event.id) ? 'Registered' : spotsLeft > 0 ? 'Register' : 'Full'}
                            </button>
                        ...
                        <button className="btn btn-outline" onClick={() => alert(`Viewing details for ${event.title}`)}>
